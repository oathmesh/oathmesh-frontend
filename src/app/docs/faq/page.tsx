...
export const metadata: Metadata = {
  title: 'FAQ',
  description:
    'Frequently asked questions about OathMesh — key rotation, downtime, Redis vs in-memory, SPIFFE comparison, and more.',
};
...
export default function FaqPage() {
  return (
    <article className="prose-oathmesh mx-auto max-w-3xl px-6 py-10">
      ...
      <p>
        Real questions from the OathMesh community. If your question isn&apos;t here, open a{' '}
        <a
      ...
      <div className="not-prose mt-8 space-y-5">
        {faqs.map((faq, i) => (
          <details key={i} className="card-surface group open:border-white/14">
            <summary className="flex cursor-pointer items-start justify-between gap-4 p-5 font-medium text-white list-none marker:hidden [&::-webkit-details-marker]:hidden">
              ...
              <span className="mt-0.5 shrink-0 text-white/40 transition-transform group-open:rotate-45">
                +
              </span>
            </summary>
