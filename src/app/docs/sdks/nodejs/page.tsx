...
export const metadata: Metadata = {
  title: 'Node.js SDK',
  description: 'OathMesh Node.js/TypeScript SDK — Express, Next.js App Router, Edge Runtime.',
};
...
export default function NodejsSdkPage() {
  return (
    <article className="prose-oathmesh mx-auto max-w-3xl px-6 py-10">
      ...
      <p>
        The <code>oathmesh</code> npm package supports Express, Next.js App Router, Hono, and any
...
export const GET = withOathMesh(
  ...
  },
  {
    ...
    actions: ['read'],
        ...
        language="typescript"
        filename="app/api/invoices/route.ts"
      />

      <Callout type="info" title="Edge Runtime compatibility">
        The Node.js SDK is fully compatible with the Next.js Edge Runtime and Cloudflare Workers. It
        uses the Web Crypto API for Ed25519 verification instead of Node.js <code>crypto</code>. No
        additional configuration is needed — the SDK detects the runtime automatically.
      </Callout>

      <h2>Minting tokens</h2>
      <CodeBlock
        code={`import { mintToken } from 'oathmesh';
