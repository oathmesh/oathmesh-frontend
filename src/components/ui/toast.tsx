...
export const toast = {
  success: (title: string, description?: string) =>
    notify([..._toasts, { id: crypto.randomUUID(), type: 'success', title, description }]),
  error: (title: string, description?: string) =>
    notify([..._toasts, { id: crypto.randomUUID(), type: 'error', title, description }]),
  info: (title: string, description?: string) =>
    notify([..._toasts, { id: crypto.randomUUID(), type: 'info', title, description }]),
};
