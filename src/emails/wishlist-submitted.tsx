...
export default function WishlistSubmittedEmail({
  name,
  title,
  description,
}: WishlistSubmittedEmailProps) {
  return (
    <Html>
      <Head />
      ...
      >
        <Container style={{ maxWidth: '560px', margin: '40px auto', padding: '0 20px' }}>
          ...
          >
            ...
            >
              Hi {name ?? 'there'}, thanks for submitting a feature request to OathMesh. The team
              will review it and may link it to a GitHub issue if planned.
            </Text>
            ...
            <Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: '13px' }}>
              ...
              to vote on other requests or track the status of yours.
            </Text>
          </Section>
        </Container>
      </Body>
