      ...
      >
        <Container style={{ maxWidth: '560px', margin: '40px auto', padding: '0 20px' }}>
          ...
          >
            ...
            >
              Your donation of <strong style={{ color: '#3385ff' }}>{amountFormatted}</strong> has
              been received and will be used to fund OathMesh infrastructure, documentation, and SDK
              development.
            </Text>
            ...
            {showOnWall && (
              <Text
                style={{ color: 'rgba(16,185,129,0.8)', fontSize: '13px', marginBottom: '16px' }}
              >
